...
<div class="tarif-form">
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Основные опции</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Описание</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость тарифа и подключения</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Услуги, включенные в абонплату</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Предоплаченные услуги</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость интернет-траффика</legend>    
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость услуги смс</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость услуги видео-звонок</legend>
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость услуг сверх абонентской платы</legend>   
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Стоимость международных звонков</legend>      
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Сноски, обозначенные * ** *** ****</legend>              
    ...
    <div class='form-group'>
        <fieldset>
            <legend class="text-primary">Статус тарифа: активный, неактивный</legend> 
