<?php
/* @var tarif backend\models\Tarif */
use yii\helpers\Html;
?>
<h2><?= Html::encode($tarif['gen_title'])?></h2>
<hr>
<div class="search-result-item">
    <div class="result-item-inner-left box-all-tarifs-data">
        <div class="box-col2">
            <div class="box-col-inner">
                    <div class="box-icons-tarifs">
                        <?php if($tarif['gen_4g_optimal'] == \backend\models\Tarif::TARIF_4G):?>
                        <span>Тариф для 4G</span>
                        <?php endif;?>
                        <br>
                        <?php if($tarif['gen_calls_optimal'] == \backend\models\Tarif::TARIF_OPTIMAL_FOR_CALLS):?>
                        <span>Тариф для звонков</span>
                        <?php endif;?>
                    </div>
                <hr>
        ...
        <div class="box-col2">
            <div class="box-col-inner">
                <div class="title_m"><b><?= Html::encode($tarif['gen_advantage_1_bold']) ?></b></div>
                <p><?= Html::encode($tarif['gen_advantage_1_desc']) ?></p>
            </div>
        </div>
        <div class="box-col2">
            <div class="box-col-inner">
                <div class="title_m"><b><?= Html::encode($tarif['gen_advantage_2_bold']) ?></b></div>
                <p><?= Html::encode($tarif['gen_advantage_2_desc']) ?></p>
            </div>
        </div>
        <div class="box-col2">
            <div class="box-col-inner">
                <div class="title_m"><b><?= Html::encode($tarif['gen_advantage_3_bold']) ?></b></div>
